...
import { Button, Container, Form, Nav, Navbar, NavDropdown, Col, Image, Dropdown } from 'react-bootstrap';
import '../../App.css'; 
      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '100px' }} navbarScroll>
            <Nav.Link as={Link} to="/Home" style={linkStyle}>Home</Nav.Link>
            <Nav.Link as={Link} to="/about" style={linkStyle}>About</Nav.Link>
            <NavDropdown as={Link} to="/Storedetail" title={<span style={linkStyle}><Link to="/Storedetail">Storedetail</Link></span>} id="navbarScrollingDropdown">
              <NavDropdown.Item href="#action3"><Link to="/Createstore">Createstore</Link></NavDropdown.Item>
              <NavDropdown.Divider />
            </NavDropdown>
            <Nav.Link as={Link} to="/Userprofil" style={linkStyle}>Userprofile</Nav.Link>
          ...
          <div className="d-flex">
            ...
            <Dropdown>
              <Dropdown.Toggle variant="light" id="dropdown-basic">
                <Col xs={6} md={4}>
                  <Image src={profileimg} roundedCircle style={headerImageStyle} />
                </Col>
              </Dropdown.Toggle>
              <Dropdown.Menu>
