...
const Contact = () => {
  const containerStyle = {
    display: 'flex',
    border: '2px solid #f9f9f9', // Green border color
  ...
  const buttonStyle = {
    ...
    margin: '10px 0 0 120px', // Reduced margin top
    border: 'none',
    borderRadius: '5px',
    backgroundColor: '#3772ff', // Green background color
    color: '#fff',
    fontSize: '10px',
    cursor: 'pointer',
    ...
    <div>
      <div style={containerStyle}>
        ...
        <div style={sidebarStyle}>
          ...
          <p style={{ margin: '5px 0' }}><a href="mailto:info@cliftonghana.com">info@suppermart stores</a></p>
          <p style={{ margin: '5px 0' }}><a href="http://www.cliftonghana.com" target="_blank" rel="noopener noreferrer">www.suppermart.com</a></p>
        </div>
      </div>
      <div style={footerStyle}>
        <p>info@suppermart stores
+233 (0)20 467 7033 / +233 (0)30 278 6726
Privacy Policy</p>
      </div>
    </div>
